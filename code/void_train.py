...
class VoidsDataset(Dataset): # torch.utils.data.Dataset
    def __init__(self, root_dir, train=True, transform=None, target_transform=None):
        ...
        self.train_file = 'yTrain.npy'#'data_train'
        self.test_file = 'yTest.npy'#'data_test'
    ...
    def __getitem__(self, index):
        ...
        #print(y.shape)
        if self.train:
            img_path = self.root_dir+'xTrain.npy'
        else:
            img_path = self.root_dir+'xTest.npy'
...
if __name__ == '__main__':
    ...
    if not os.path.exists('void_project/data/xTrain.npy'):
